...
$pageInscriptionLocations->contenu .= '<section>
		...
		<article>
			<form class="form" id="formInscriptionLocations" method="post" action="../CONTROLEUR/tt_AjoutLocationClassique.php">
            
            <p> Quel vélo voulez vous louer ? </p>
    </br>
    
    <div class="form-group">
    <label>Choisissez votre vélo : </label>
    <select  class="form-control" name="numV" id="numV">';

              $listeVelos = listeVelosClassiquesDisponibles();
                   
              
                foreach($listeVelos as $unVELO)
                {
